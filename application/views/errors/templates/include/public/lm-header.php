...
<!-- saved from url=(0055)http://www.limononoto.com/ -->
  <head>
  	<meta charset="UTF-8">
...
;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"32be86c3b5",applicationID:"64980743",sa:1}
</script>
    <title><?php echo $this->title ?></title>
    <base href="<?php echo base_url();?>" />
    <script type="text/javascript">
        //<![CDATA[
        var val_url = '<?php echo base_url();?>';
        var get_url = '<?php echo uri_string();?>';
        //]]>
    </script>
  ...
  <body class="lm-body lm-layout-responsive lm-show body" data-spy="scroll" data-target=".bs-docs-sidebar">
