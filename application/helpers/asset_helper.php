 ...
 * @return  string
 */
if ( ! function_exists('css_bower'))
{
    function css_bower()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return base_url('cdn/') .$ci->config->item('css_path');
    }
}
if ( ! function_exists('js_bower'))
{
    function js_bower()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return base_url('cdn/') .$ci->config->item('js_path');
    }
}
if ( ! function_exists('css_url'))
{
    function css_url()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return cdn_url().$ci->config->item('css_path');
    }
}
...
if ( ! function_exists('less_url'))
{
    function less_url()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return cdn_url().$ci->config->item('less_path');
    }
}
...
if ( ! function_exists('js_url'))
{
    function js_url()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return cdn_url().$ci->config->item('js_path');
    }
}
...
if ( ! function_exists('img_url'))
{
    function img_url()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return cdn_url().$ci->config->item('img_path');
    }
}
...
if ( ! function_exists('swf_url'))
{
    function swf_url()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return cdn_url().$ci->config->item('swf_path');
    }
}
...
if ( ! function_exists('upload_url'))
{
    function upload_url()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return cdn_url().$ci->config->item('upload_path');
    }
}
...
if ( ! function_exists('download_url'))
{
    function download_url()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return cdn_url().$ci->config->item('download_path');
    }
}
...
if ( ! function_exists('xml_url'))
{
    function xml_url()
    {
        $ci =& get_instance();
        $ci->config->load('asset');
        return cdn_url().$ci->config->item('xml_path');
    }
}
